...
const SampleFont = () => {
  ...
  return (
      <View style={styles.container}>
        ...
        <HeadingSemiBold40 color={theme.color.sys.primary.default}>
          Display 2
        </HeadingSemiBold40>
        <HeadingSemiBold32 color={theme.color.theme.secondaryText}>
          Display 3
        </HeadingSemiBold32>
        <HeadingSemiBold28 color={theme.color.theme.disabled}>
          Heading 1 Semibold
        </HeadingSemiBold28>
