...
const Search: React.FC<InputProps> = ({ placeholder = "원하는 식당을 검색해 보세요", isDisabled = false }) => {
...
const InputWrapper = styled.View<InputProps & { theme: DefaultTheme }>`
  border: 1px solid ${({ state, theme }) => (state === "focused" ? "transparent" : theme.color.theme.border)};
